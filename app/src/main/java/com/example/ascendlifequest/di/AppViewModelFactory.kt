...
/**
 * Factory for creating ViewModels with injected dependencies. Provides default implementations for
 * repositories when not specified.
 */
class AppViewModelFactory(
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
                ...
                val providedProfileRepo =
                        profileRepository ?: ProfileRepositoryImpl(providedAuthRepo)
